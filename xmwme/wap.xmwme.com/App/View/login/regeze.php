			...
			<div class="input-box">
				<div class="inner">
					...
					<div class="rcon">
						...
						<img src="/verify/index/" class="img-code" onclick='BB.form.changeVerify()'>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="input-box">
				<div class="inner">
					...
					<div class="rcon">
						...
						<input name="telephone" id="telephone" value="18201197911" type="hidden">
...
<script src="/Resource/js/base.js?d=1711221436"></script>
	...
	<script src="/Resource/js/user/register.js?t=1701161449"></script>
	<script>
		var telephone = 18201197911;
	</script>
	
<span style="display:none">
<img src="http://c.cnzz.com/wapstat.php?siteid=1256636065&r=http%3A%2F%2Fwap.bbqb.co%2Flogin%2F%3Fs%3D2sS6IF1weDxjyWaNaH7Q1v7NBqntR4Ce&rnd=1758991947" width="0" height="0"/></span>
</body>
</html>
