...
<html lang="zh-CN">
    ...
    </head><body class="pg-ab">
        <div class="tab">
<!--            <ul>
                <li class="active"><a href="/staticpage/aboutus/">关于我们</a></li>
                <li><a href="/staticpage/insurance/">安全保障</a></li>
            </ul>-->
        </div>
    <body class="pg-ab">
        <!--<div class="head"></div>-->
        <dl class="item">
            <dt>
            <div class="icon-w"><img src="/Resource/images/logo_bbqb.png" style="width:2.1rem"></div>
            <h3>食物百科网</h3>
            <p>食物百科让生活更有趣</p>
            </dt>
            <dd>
                <p>食物百科网是一个分享食物故事，讲述事务历史等，趣味平台。</p>
                <p>联系我们：1、搜索《食物百科传》公众号。2、QQ群:583307370</p>
            </dd>
        </dl>
    </body>
</html>