...
class Dispatcher implements IDispatcher
{
	...
	public function parseReq()
	{
		...
		if($mod != $this->module) $this->module = ucfirst($mod).'Action';  //限制action类名
		...
		{
			RunException::writeLog("控制器 $mod 未找到!",'error.log');
