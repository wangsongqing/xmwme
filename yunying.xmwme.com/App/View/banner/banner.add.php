...
<main>
    ...
    <section class="content">
        <header class="content-header">添加banner</header>
        <fieldset class="form-list-32 form-list-32-1">
            <form action="/banner/add/" method="post" id="servicecost" enctype="multipart/form-data">
                <ul>
                    <li>
                        <h6>活动：</h6>
                        <p>
                    ...
                    <li>
                        <h6>banner名称：</h6>
                        <p><input class="tbox30" type="text" value="" name="banner_name" id="banner_name"></p>
                    </li>
